...
const SubscriptionCard = ({name, price, currency, icon, billing, color, plan, category, renewalDate,paymentMethod,startDate, onPress, expanded, status }:SubscriptionCardProps) => {
  return (
